  ...
  return (
    <main className="min-h-screen bg-gray-900 p-4">
      <div className="max-w-6xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold text-white text-center mb-8">System Monitor</h1>
        
        {metrics && (
          <>
            {/* CPU Metrics */}
            <section className="bg-gray-800 rounded-lg p-6 shadow-lg">
              <h2 className="text-2xl font-bold text-white mb-4">CPU - {metrics.cpu.name}</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-white">
                ...
                <div className="bg-gray-700 p-4 rounded">
                  ...
                  <p className="text-2xl font-bold">{metrics.cpu.core_count}</p>
                </div>
                <div className="bg-gray-700 p-4 rounded">
                  <p className="text-sm text-gray-300">Frequency</p>
                  <p className="text-2xl font-bold">{metrics.cpu.frequency} MHz</p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-gray-800 rounded-lg p-6 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-white">
                ...
                <div className="bg-gray-700 p-4 rounded">
                  ...
                  <p className="text-2xl font-bold">{(metrics.memory.used_memory / 1024 / 1024 / 1024).toFixed(2)} GB</p>
                </div>
                <div className="bg-gray-700 p-4 rounded">
                  <p className="text-sm text-gray-300">Total</p>
                  <p className="text-2xl font-bold">{(metrics.memory.total_memory / 1024 / 1024 / 1024).toFixed(2)} GB</p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-gray-800 rounded-lg p-6 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-white">
                <div className="bg-gray-700 p-4 rounded">
                  ...
                  <p className="text-2xl font-bold">{(metrics.disk.total_space / 1024 / 1024 / 1024).toFixed(2)} GB</p>
                </div>
                <div className="bg-gray-700 p-4 rounded">
                  <p className="text-sm text-gray-300">Used Space</p>
                  <p className="text-2xl font-bold">{(metrics.disk.used_space / 1024 / 1024 / 1024).toFixed(2)} GB</p>
                </div>
                <div className="bg-gray-700 p-4 rounded">
                  <p className="text-sm text-gray-300">Available</p>
                  <p className="text-2xl font-bold">{(metrics.disk.available_space / 1024 / 1024 / 1024).toFixed(2)} GB</p>
                </div>
              </div>
            </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-white">
                <div className="bg-gray-700 p-4 rounded">
                  ...
                  <p className="text-2xl font-bold">
                    {(() => {
                      const bytesPerSec = metrics.network.total_bytes_received / 2;
                ...
                <div className="bg-gray-700 p-4 rounded">
                  ...
                  <p className="text-2xl font-bold">
                    {(() => {
                      const bytesPerSec = metrics.network.total_bytes_transmitted / 2;
                      if (bytesPerSec < 1024) return `${bytesPerSec.toFixed(2)} B/s`;
                      if (bytesPerSec < 1024 * 1024) return `${(bytesPerSec / 1024).toFixed(2)} KB/s`;
                      return `${(bytesPerSec / 1024 / 1024).toFixed(2)} MB/s`;
                    })()}
            ...
            <section className="bg-gray-800 rounded-lg p-6 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-white">
                <div className="bg-gray-700 p-4 rounded">
                  ...
                  <p className="text-2xl font-bold">{Math.floor(metrics.uptime / 3600)}h {Math.floor((metrics.uptime % 3600) / 60)}m</p>
                </div>
                <div className="bg-gray-700 p-4 rounded">
                  <p className="text-sm text-gray-300">Load Average (1m)</p>
                  <p className="text-2xl font-bold">{metrics.load_average[0].toFixed(2)}</p>
                </div>
                <div className="bg-gray-700 p-4 rounded">
                  <p className="text-sm text-gray-300">Load Average (5m)</p>
                  <p className="text-2xl font-bold">{metrics.load_average[1].toFixed(2)}</p>
                </div>
              </div>
            </section>
          </>
